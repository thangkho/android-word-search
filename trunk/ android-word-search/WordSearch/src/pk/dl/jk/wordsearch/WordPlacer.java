                                ...
                                case NORTH:
                                    ...
                                    if((words[0].length() - 1 + yPos) <= 9){
                                        ...
                                        if(words[2] != null){
                                            ...
                                            if((xPos - location2) >= 0 && (xPos + ((words[2].length()-1) - location2)) <= 9
                                        ...
                                        if(words[3] != null){
                                            ...
                                            if((xPos + location2) <= 9 && (xPos - ((words[3].length() - 1) - location2)) >= 0 
                                                    && (yPos  + location + ((words[3].length() - 1) - location2)) <= 9 && (yPos  + location - location2) >= 0){
                                    ...
                                    if((words[0].length() - 1 + xPos) <= 9){
                                        ...
                                        if(words[2] != null){
                                            ...
                                            if((xPos + location - location2) >= 0 && (xPos + location + ((words[2].length()-1) - location2)) <= 9
                                                    && (yPos - location2) >= 0 && (yPos + ((words[2].length()-1) - location2)) <= 9){
                                                    while(count3 < words[2].length() && fits == true){
                                                        location2 = words[2].indexOf(temp2) - count3;
                                                         
                                                        if(!(grid[xPos  + location - location2][yPos - location2].equalsIgnoreCase("*")) &&
                                                                !(grid[xPos  + location - location2][yPos - location2].equalsIgnoreCase(Character.toString(words[2].charAt(count3))))){
                                        ...
                                        if(words[3] != null){
                                            ...
                                            if((xPos + location + location2) <= 9 && (xPos + location - ((words[3].length() - 1) - location2)) >= 0 
                                                    ...
                                                    while(count4 < words[3].length() && fits == true){
                                                        ...
                                                        if(!(grid[xPos + location + location2][yPos - location2].equalsIgnoreCase("*")) &&
                                                                !(grid[xPos + location + location2][yPos - location2].equalsIgnoreCase(Character.toString(words[3].charAt(count4))))){
                                            ...
                                            count4 = 0;
                                                ...
                                                if(words[2] != null){
                                                    ...
                                                    while(count3 < words[2].length()){
                                                        ...
                                                        grid[xPos  + location - location2][yPos - location2] = Character.toString(words[2].charAt(count3));
                                                ...
                                                if(words[3] != null){
                                                    ...
                                                    while(count4 < words[3].length()){
                                                        ...
                                                        grid[xPos + location + location2][yPos - location2] = Character.toString(words[3].charAt(count4));
